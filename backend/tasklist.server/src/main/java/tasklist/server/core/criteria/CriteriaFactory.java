package tasklist.server.core.criteria;
...
import tasklist.server.core.hibernate.service.HibernateManagerSessionFactoryService;
import tasklist.server.core.spring.context.ScopeType;
...
public final class CriteriaFactory {
     ...
     */
    private void buildCriteriaBuilder() {
        if (criteriaBuilder == null) {
            criteriaBuilder = new CriteriaBuilderImpl(ClassUtils.toAssignable(SessionFactoryImpl.class, hibernateManagerSessionFactoryService.getSessionFactory()));
        }
    }
