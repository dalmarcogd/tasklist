package tasklist.server.core.spring.config.security;
...
import tasklist.server.core.hibernate.config.HibernateConfig;
import tasklist.server.core.hibernate.transaction.CustomHibernateTransactionManager;
...
public class SpringWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "tasklist.server" });
